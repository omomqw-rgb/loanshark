(function (window, document) {
  ...
  App.features.statisticsEngine = (function () {
    ...
    function buildContext(agg) {
      ...
      // 6) Debtor Statistics
      var totalDebtors = counts.totalDebtors || 0;
      var loanPrincipalTotal = Number(totals.loanPrincipalTotal || totals.loanPrincipal || 0) || 0;
      var avgLoanPrincipal = totalDebtors ? (loanPrincipalTotal / totalDebtors) : 0;
      var avgClaimAmount = totalDebtors ? (claimAmount / totalDebtors) : 0;

      var debtors = {
        '채무자 수': totalDebtors,
        '채무자 1인당 평균 대출원금': avgLoanPrincipal,
        '채무자 1인당 평균 채권금액': avgClaimAmount
      };
