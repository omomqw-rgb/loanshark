...
App.debtors.renderItem = function (d) {
  ...
  wrap.addEventListener("click", function () {
    ...
    // 실제 상세 렌더링은 DebtorDetail DOM에 위임
    if (App.debtorDetail && typeof App.debtorDetail.render === "function") {
      App.debtorDetail.render(id);
    } else if (App.debtors && typeof App.debtors.openDetail === "function") {
      App.debtors.openDetail(id);
    }
    // 패널 show/hide 는 DebtorDetail 쪽(App.debtorPanel.showDetail)에서 한 번만 처리
  });
