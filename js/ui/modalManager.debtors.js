(function (window, document) {
  ...
  function attachModalEvents() {
    ...
    modalRoot.addEventListener('submit', function (event) {
      ...
      if (kind === 'debtor-create' && api.handleDebtorCreate) {
        api.handleDebtorCreate(form);
      } else if (kind === 'debtor-edit' && api.handleDebtorEdit) {
      ...
      } else if (kind === 'schedule-loan' && api.handleLoanScheduleSave) {
        api.handleLoanScheduleSave(form);
      } else if (kind === 'schedule-claim' && api.handleClaimScheduleSave) {
